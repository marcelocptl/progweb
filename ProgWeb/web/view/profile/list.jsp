            ...
            <c:forEach items="${profiles}" var="profile">
                <tr>
                    ...
                    <td>
                        ...
                        <a href="PermissionController?action=permission&id=<c:out value="${profile.getId()}" />"><button type="button" class="btn btn-warning btn-xs"><span class="glyphicon glyphicon-lock"></span></button></a>
